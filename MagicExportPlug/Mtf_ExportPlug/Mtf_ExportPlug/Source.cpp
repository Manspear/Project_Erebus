...
EXPORT MStatus initializePlugin(MObject obj)
{
	...
	Exporter Export;
	string outfileModel = "C:/Project_Erebus/MagicExportPlug/Exports/";
	string outfileMaterial = "C:/Project_Erebus/MagicExportPlug/Exports/";

	Export.writeModelsToFile(outfileMaterial);
