...
int main()
{
	...
	AABBCollider aabb5 = AABBCollider(-1, glm::vec3(36, 36, 36), glm::vec3(40, 40, 40));
	...
	SphereCollider* sphere4[30];
	//for (size_t i = 0; i < 30; i++)
	//{
	//	sphere4[i] = new SphereCollider(-1, glm::vec3(i, i, i), .5f);
	//	collisionHandler.addHitbox(sphere4[i]);
	//}
