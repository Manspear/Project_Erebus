...
Transform.SetPosition(level01.props.CombinationBarrierID.transformID, {x=28.8451, y=10.3811, z=192.659})
Transform.SetScaleNonUniform(level01.props.CombinationBarrierID.transformID, 1, 0.8, 0.7)
Transform.SetRotation(level01.props.CombinationBarrierID.transformID, {x=0, y=-0.972471, z=0})
...
level01.props.CombinationBarrierID.collider:SetZAxis(0.587146,0,0.809481)
level01.props.CombinationBarrierID.collider:SetHalfLengths(3,4,0.7)
level01.props.CombinationBarrierID.collider:SetPos(28.8451,10.3811,192.659)
...
Transform.SetPosition(level01.triggers.TutorialPostID.transformID, {x=28.3438, y=7.40625, z=141.75})
Transform.SetScaleNonUniform(level01.triggers.TutorialPostID.transformID, 1, 1, 1)
Transform.SetRotation(level01.triggers.TutorialPostID.transformID, {x=0, y=0, z=0})
level01.triggers.TutorialPostID.collider = AABBCollider.Create(-1)
...
level01.triggers.BlockerCombinerID.collider:SetZAxis(-0.802376,0,0.596819)
level01.triggers.BlockerCombinerID.collider:SetHalfLengths(2,3,4)
level01.triggers.BlockerCombinerID.collider:SetPos(27.7107,10.2922,191.228)
...
level02.props.BlockerClosedID.collider = OBBCollider.Create(-1)
level02.props.BlockerClosedID.collider:SetOffset(0,0,0)
level02.props.BlockerClosedID.collider:SetZAxis(-0.984375,0,0.176085)
level02.props.BlockerClosedID.collider:SetHalfLengths(0.5,9,12.6809)
level02.props.BlockerClosedID.collider:SetPos(153,41.5311,189)
CollisionHandler.AddOBB(level02.props.BlockerClosedID.collider, 3)
...
Transform.SetPosition(level02.props.BlockerOpenID.transformID, {x=151.797, y=32.4272, z=194.507})
Transform.SetScaleNonUniform(level02.props.BlockerOpenID.transformID, 1.02954, 1.29459, 1.79665)
Transform.SetRotation(level02.props.BlockerOpenID.transformID, {x=0, y=1.74849, z=0})
level02.enemies.New21ID = CreateEnemy(ENEMY_DUMMY, {x=46.7188, y=7.63672, z=175.375})
level02.enemies.New21ID.moveSpeed = 9
level02.enemies.New21ID.health = 50
level02.enemies.New21ID.visionRange = 30

level02.enemies.New22ID = CreateEnemy(ENEMY_DUMMY, {x=49.7188, y=7.78125, z=181.625})
level02.enemies.New22ID.moveSpeed = 9
level02.enemies.New22ID.health = 50
level02.enemies.New22ID.visionRange = 30

level02.enemies.New23ID = CreateEnemy(ENEMY_DUMMY, {x=54.2813, y=7.98438, z=174.375})
level02.enemies.New23ID.moveSpeed = 9
level02.enemies.New23ID.health = 50
level02.enemies.New23ID.visionRange = 30

level02.enemies.New24ID = CreateEnemy(ENEMY_DUMMY, {x=19.0469, y=4.00391, z=196})
level02.enemies.New24ID.moveSpeed = 9
level02.enemies.New24ID.health = 50
level02.enemies.New24ID.visionRange = 30

level02.enemies.New25ID = CreateEnemy(ENEMY_DUMMY, {x=14.3516, y=3.56836, z=198})
level02.enemies.New25ID.moveSpeed = 9
level02.enemies.New25ID.health = 50
level02.enemies.New25ID.visionRange = 30

level02.enemies.New26ID = CreateEnemy(ENEMY_DUMMY, {x=8.24219, y=3.5918, z=198.5})
level02.enemies.New26ID.moveSpeed = 9
level02.enemies.New26ID.health = 50
level02.enemies.New26ID.visionRange = 30
...
level02.triggers.BlockerTriggerID.collider:SetPos(152.841,38.4688,191.468)
...
DestroyEnemy(level02.enemies.New21ID)
DestroyEnemy(level02.enemies.New22ID)
DestroyEnemy(level02.enemies.New23ID)
DestroyEnemy(level02.enemies.New24ID)
DestroyEnemy(level02.enemies.New25ID)
DestroyEnemy(level02.enemies.New26ID)
