...
level01.colliders.OpWall1693ID.collider:SetPos(54.5,8.01322,183)
...
level01.colliders.OpWall70147ID.collider:SetPos(34.5,8.45509,207.5)
...
level01.props.CombinationBarrier741ID = {}
level01.props.CombinationBarrier741ID.model = Assets.LoadModel('Models/Stone3.model')
level01.props.CombinationBarrier741ID.transformID = Gear.BindStaticInstance(level01.props.CombinationBarrier741ID.model)
Transform.SetPosition(level01.props.CombinationBarrier741ID.transformID, {x=30.3906, y=8.39063, z=194.75})
Transform.SetScaleNonUniform(level01.props.CombinationBarrier741ID.transformID, 2, 2, 2)
Transform.SetRotation(level01.props.CombinationBarrier741ID.transformID, {x=0, y=0, z=0})
level01.props.CombinationBarrier741ID.collider = OBBCollider.Create(-1)
level01.props.CombinationBarrier741ID.collider:SetOffset(0,0,0)
level01.props.CombinationBarrier741ID.collider:SetZAxis(-0.350783,0,-0.936457)
level01.props.CombinationBarrier741ID.collider:SetHalfLengths(6,10,2)
level01.props.CombinationBarrier741ID.collider:SetPos(30.3906,8.39063,194.75)
CollisionHandler.AddOBB(level01.props.CombinationBarrier741ID.collider, 3)
level01.triggers.CombinationBarrierTrigger742ID = {}
level01.triggers.CombinationBarrierTrigger742ID.collider = OBBCollider.Create(-1)
level01.triggers.CombinationBarrierTrigger742ID.collider:SetOffset(0,0,0)
level01.triggers.CombinationBarrierTrigger742ID.collider:SetZAxis(0.909297,0,-0.416147)
level01.triggers.CombinationBarrierTrigger742ID.collider:SetHalfLengths(2,3,3)
level01.triggers.CombinationBarrierTrigger742ID.collider:SetPos(29.8642,8.26578,194.995)
level01.triggers.CombinationBarrierTrigger742ID.collider.OnExit = function() hideTutorialImage()end
level01.triggers.CombinationBarrierTrigger742ID.collider.OnTriggering = function(dt) TutorialBarrier(CombinationBarrier,918,dt) end 
level01.triggers.CombinationBarrierTrigger742ID.collider.triggered = false
CollisionHandler.AddOBB(level01.triggers.CombinationBarrierTrigger742ID.collider, 4)
end
...
Gear.UnbindInstance(level01.props.CombinationBarrier741ID.transformID)
level01.props.CombinationBarrier741ID = nil
level01.triggers.CombinationBarrierTrigger742ID = nil
level01.props = nil
