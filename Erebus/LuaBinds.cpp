					...
					PerformanceCounter* counter )
{
	...
	LuaGear::registerFunctions( lua, gearEngine, models, animatedModels, animations, boundAnimations, forwardModels, textureBlends, queueModels, mouseVisible, fullscreen, assets, work );
