...
WoodenFence82ID = {}
WoodenFence82ID.transformID = Transform.Bind()
Transform.SetPosition(WoodenFence82ID.transformID, {x=23.6625, y=5.29802, z=199.326})
Transform.SetScaleNonUniform(WoodenFence82ID.transformID, 1, 1, 1)
Transform.SetRotation(WoodenFence82ID.transformID, {x=0.194112, y=-1.19496, z=0})
WoodenFence82ID.model = Assets.LoadModel('Models/Wooden_Fence.model')
Gear.AddStaticInstance(WoodenFence82ID.model, WoodenFence82ID.transformID)
WoodenFence82ID.collider = OBBCollider.Create(WoodenFence82ID.transformID)
WoodenFence82ID.collider:SetOffset(0,0,0)
WoodenFence82ID.collider:SetZAxis(-0.91273,-0.192895,0.36016)
WoodenFence82ID.collider:SetHalfLengths(0.5,1,3)
CollisionHandler.AddOBB(WoodenFence82ID.collider, 3)
table.insert(props,WoodenFence82ID)
WoodenFence82ID = nil

WoodenFence183ID = {}
WoodenFence183ID.transformID = Transform.Bind()
Transform.SetPosition(WoodenFence183ID.transformID, {x=18.6692, y=4.79427, z=200.977})
Transform.SetScaleNonUniform(WoodenFence183ID.transformID, 1, 1, 1)
Transform.SetRotation(WoodenFence183ID.transformID, {x=0, y=-1.34457, z=0})
WoodenFence183ID.model = Assets.LoadModel('Models/Wooden_Fence.model')
Gear.AddStaticInstance(WoodenFence183ID.model, WoodenFence183ID.transformID)
WoodenFence183ID.collider = OBBCollider.Create(WoodenFence183ID.transformID)
WoodenFence183ID.collider:SetOffset(0,0,0)
WoodenFence183ID.collider:SetZAxis(-0.974519,0,0.224304)
WoodenFence183ID.collider:SetHalfLengths(0.5,1,3)
CollisionHandler.AddOBB(WoodenFence183ID.collider, 3)
table.insert(props,WoodenFence183ID)
WoodenFence183ID = nil

WoodenFence284ID = {}
WoodenFence284ID.transformID = Transform.Bind()
Transform.SetPosition(WoodenFence284ID.transformID, {x=13.6393, y=4.83612, z=201.995})
Transform.SetScaleNonUniform(WoodenFence284ID.transformID, 1, 1, 1)
Transform.SetRotation(WoodenFence284ID.transformID, {x=0, y=-1.40734, z=0})
WoodenFence284ID.model = Assets.LoadModel('Models/Wooden_Fence.model')
Gear.AddStaticInstance(WoodenFence284ID.model, WoodenFence284ID.transformID)
WoodenFence284ID.collider = OBBCollider.Create(WoodenFence284ID.transformID)
WoodenFence284ID.collider:SetOffset(0,0,0)
WoodenFence284ID.collider:SetZAxis(-0.986671,0,0.162729)
WoodenFence284ID.collider:SetHalfLengths(0.5,1,3)
CollisionHandler.AddOBB(WoodenFence284ID.collider, 3)
table.insert(props,WoodenFence284ID)
WoodenFence284ID = nil

WoodenFence385ID = {}
WoodenFence385ID.transformID = Transform.Bind()
Transform.SetPosition(WoodenFence385ID.transformID, {x=8.49151, y=4.72769, z=202.459})
Transform.SetScaleNonUniform(WoodenFence385ID.transformID, 1, 1, 1)
Transform.SetRotation(WoodenFence385ID.transformID, {x=0, y=-1.5708, z=0})
WoodenFence385ID.model = Assets.LoadModel('Models/Wooden_Fence.model')
Gear.AddStaticInstance(WoodenFence385ID.model, WoodenFence385ID.transformID)
WoodenFence385ID.collider = OBBCollider.Create(WoodenFence385ID.transformID)
WoodenFence385ID.collider:SetOffset(0,0,0)
WoodenFence385ID.collider:SetZAxis(-1,0,-4.37114e-08)
WoodenFence385ID.collider:SetHalfLengths(0.5,1,3)
CollisionHandler.AddOBB(WoodenFence385ID.collider, 3)
table.insert(props,WoodenFence385ID)
WoodenFence385ID = nil

ObbRot288ID = {}
ObbRot288ID.transformID = Transform.Bind()
Transform.SetPosition(ObbRot288ID.transformID, {x=126.338, y=35.1852, z=228.83})
Transform.SetScaleNonUniform(ObbRot288ID.transformID, 1, 4.67355, 8.69229)
...
ObbRot288ID.collider:SetHalfLengths(0.5,2.33678,4.34615)
...
Transform.SetPosition(ObbRot389ID.transformID, {x=133.49, y=37.6444, z=224.246})
Transform.SetScaleNonUniform(ObbRot389ID.transformID, 15.3474, 9.45279, 1)
...
ObbRot389ID.collider:SetHalfLengths(7.67372,4.7264,0.5)
...
Transform.SetPosition(ObbRot28132ID.transformID, {x=112.962, y=33.7681, z=232.315})
Transform.SetScaleNonUniform(ObbRot28132ID.transformID, 1, 17.5988, 28.455)
...
ObbRot28132ID.collider:SetHalfLengths(0.5,8.79939,14.2275)
...
Transform.SetRotation(t2s368ID.transformID, {x=0, y=255, z=0})
