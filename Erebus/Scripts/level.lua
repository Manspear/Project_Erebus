...
local tile1 = Assets.LoadModel( "Models/tile1.model" )
heightmaps[1].transformID = Gear.BindStaticInstance(tile1)
...
local tile1_assets = Assets.LoadModel( "Models/tile1_assets.model" )
heightmaps[1].assetsTransform = Gear.BindStaticInstance(tile1_assets)
Transform.SetPosition(heightmaps[1].assetsTransform, {x=0, y=0, z=128})

--Tile2-----------------------------------------------------------------
--local tile2 = Assets.LoadModel("Models/tile2.model")
--Gear.AddStaticInstance(tile2, heightmaps[2].transformID)
local tile2 = Assets.LoadModel( "Models/tile2.model" )
heightmaps[2].transformID = Gear.BindStaticInstance(tile2)
...
local goblin = Assests.LoadModel( "Models/Goblin.model" )
heightmaps[5].transformID = Gear.BindStaticInstance(goblin)
...
local tree = Assets.LoadModel( "Models/PineTree2.model" )
heightmaps[6].transformID = Gear.BindStaticInstance(tree)
