...
Transform.SetPosition(enemies[1].transformID, {x=100, y=26, z=64})
Transform.SetPosition(enemies[2].transformID, {x=44, y=0, z=20})
Transform.SetPosition(enemies[3].transformID, {x=32, y=0, z=26})
