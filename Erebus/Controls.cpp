...
void Controls::update( Inputs* input )
{
	...
	keys[8] = input->buttonPressedThisFrame( GLFW_KEY_1 );
	keys[9] = input->buttonPressedThisFrame( GLFW_KEY_2 );
	keys[10] = input->buttonPressedThisFrame( GLFW_KEY_3 );
	keys[11] = input->buttonPressedThisFrame( GLFW_KEY_4 );
